...
function saveAttribute($attribute_name, $attribute_values) {

    global $cMySQLi;
    STX_DB();

    $iQuery = "INSERT INTO ".MYSQL_TBL_ATTRIBUTE." (attribute_name, attribute_value) VALUES".chr(10);
    $iQuery .= "('$attribute_name', '$attribute_values')";
