...
switch(strtoupper($key)) {
    case 'ADD':
        ...
        $attribute_type = (isset($_POST['attribute_type']) && !empty($_POST['attribute_type'])) ? $_POST['attribute_type'] : "";
        $attribute_values = (isset($_POST['attribute_value']) && !empty($_POST['attribute_value'])) ? $_POST['attribute_value'] : "";
        $id = saveAttribute($attribute_name, $attribute_type, $attribute_values);
        break;
